...
const headCells = [
  ...
  { id: 'deskName', hideSortIcon: false, label: 'Bàn làm việc' },
  // { id: 'teleToken', hideSortIcon: false, label: 'TeleToken' },
  // { id: 'chatId', hideSortIcon: false, label: 'ChatId' },
        ...
        {headCells.map((headCell) => (
          <TableCell
            ...
            className={
              ...
              (headCell.id === "fullName" ? "MuiTableCell-freeze header_title" : "")
            }>
            <TableSortLabel
                ...
                userModels.map((row, index) => {
                  return (
                    <TableRow hover tabIndex={-1} key={row.id}>
                      <TableCell className="MuiTableCell-freeze">{row.fullName}</TableCell>
                      <TableCell>{row.deskName ?? 'Chưa có'}</TableCell>
                      {/* <TableCell>{row.teleToken}</TableCell>
