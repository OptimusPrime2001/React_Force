...
const listTableCell = [
    { id: 'stt', hideSortIcon: true, isSort: false, label: 'STT', width: '' },
    { id: 'user', hideSortIcon: true, isSort: false, label: 'Nhân viên', width: '' },
...
const TopUser = () => {
    ...
    const getTopUser = async (params) => {
        try {
            const { content } = await dashboardAction.GetTopUser(params);
    ...
    return (
        <div className='dashboard_container'>
            <ReportHeader title="Xếp hạng nhân viên"/>
            {/* <Planning
                data={data}
                isTopUser
            /> */}
                                        ...
                                        if (!item.isDelete)
                                            return (
                                                <TableRow hover tabIndex={-1} key={item.id}>
                                                    ...
                                                    <TableCell className="MuiTableCell-freeze">{item.user}</TableCell>
