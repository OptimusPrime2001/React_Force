export const UrlCollection = {
  ...
  // --- video store
  CameraManagement: "/management/camera",
  UserManagement: "/management/user",
  ScannerManagement: "/management/scanner",
  RoleManagement: '/management/role-management',
  OrderManagement: '/management/order',
  OrderVideo: `/management/order/video`,
  Dashboard: '/dashboard',
  Report: '/report',
  TopUser: '/report/top-user',
  MyReport: '/report/my-report',
  MySalaryReport: '/report/my-salary-report',
  AllReport: '/report/all-report',
  // --- video store
};
