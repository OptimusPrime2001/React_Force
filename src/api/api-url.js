...
//---SoundWave---//
  ...
  Genres_GetLookup: "api/admin/Genres/GetLookup",
  ...
  Moods_GetLookup: "api/admin/Moods/GetLookup",
  ...
  Themes_GetLookup: "api/admin/Themes/GetLookup",
  ...
  SoundEffect_GetLookup: "api/admin/SoundEffect/GetLookup",
  ...
  Track_GetDetail: (id) => `api/admin/Track/GetById/${id}`,
...
//---Scanner
Scanner_GetAll: "api/admin/Desk/GetAll",
Scanner_Create: "api/admin/Desk/Create",
Scanner_Update: "api/admin/Desk/Update",
Scanner_Delete: (id) => `api/admin/Desk/Delete/${id}`,
Scanner_GetDetail: (id) => `api/admin/Desk/GetDetail/${id}`,
Scanner_GetLookup: "api/admin/Desk/GetLookup",

//---Camera
Camera_GetAll: "api/admin/Camera/GetAll",
Camera_Create: "api/admin/Camera/Create",
Camera_Update: "api/admin/Camera/Update",
Camera_Delete: (id) => `api/admin/Camera/Delete/${id}`,
Camera_GetDetail: (id) => `api/admin/Camera/GetDetail/${id}`,

//---Order
Order_GetAll: "api/admin/Order/GetAll",
Order_Create: "api/admin/Order/Create",
Order_Update: "api/admin/Order/Update",
Order_Delete: (id) => `api/admin/Order/Delete/${id}`,
Order_GetDetail: (id) => `api/admin/Order/GetDetail/${id}`,
UpdateOrderStatus: 'api/admin/Order/UpdateOrderStatus',
Video_GetAll: "api/admin/Video/GetAll",

//---Dashboard
GetTopUser: 'GetTopUser',
GetAllReport: 'GetAllReport',
GetMyReport: 'GetMyReport',
